  ...
  <v-container>
    <v-row>
      <v-col cols="12" sm="6">
        <v-select
          ...
          label="开始年份"
          @update:model-value="handleYearChange('start')"
        ></v-select>
      </v-col>
      <v-col cols="12" sm="6">
        <v-select
          ...
          @update:model-value="handleYearChange('end')"
        ></v-select>
      </v-col>
    </v-row>
    ...
    <v-row>
      ...
      <v-col cols="12" sm="6">
        <v-select
          v-model="endMonth"
          :items="availableEndMonths"
          label="结束月份"
          item-title="text"
          item-value="value"
          :disabled="
            endYear === null || (startYear === endYear && startMonth === null)
          "
