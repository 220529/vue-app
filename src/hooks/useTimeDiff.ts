...
function calculateTimeDiff(startTime: string, endTime: string = new Date().toISOString()): {
    days: number;
    hours: number;
    minutes: number;
    seconds: number;
...
export function useTimeDiff(startTime: string, endTime: string = new Date().toISOString()): {
    days: number;
    hours: number;
    minutes: number;
    seconds: number;
